    ...
    <div class="left">
        ...
        <div>Etage :
            <select name="port" id="portForm" onchange="checkPort()">
                <option <?php if (getFloor() == "") {
                            echo "selected";
                        } ?> value="">0</option>
                <option <?php if (getFloor() == ":8000") {
                            echo "selected";
                        } ?> value="8000">1</option>
                <option <?php if (getFloor() == ":7259") {
                            echo "selected";
                        } ?> value="7259">2</option>
            </select>
        </div>
    ...
    <div class="right">
        ...
        <div id="gauche-contenu">
            <select class="custom-select" name="method">
                <option <?php if (getMethod() == "GET") {
                            echo "selected";
                        } ?> value="GET">GET</option>
                <option <?php if (getMethod() == "POST") {
                            echo "selected";
                        } ?> value="POST">POST</option>
                <option <?php if (getMethod() == "PUT") {
                            echo "selected";
                        } ?> value="PUT">PUT</option>
                <option <?php if (getMethod() == "DELETE") {
                            echo "selected";
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input class="submit-button" type="submit" value="Evoyer la requête">
        </div>
    </div>
</div>